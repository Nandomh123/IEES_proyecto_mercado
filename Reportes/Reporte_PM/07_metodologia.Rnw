...
\section{Tablas y los gráficos creados}

En la figura \ref{fig:iess_pir_egresados}, se presenta la distribución de los egresados de la EPN, por sexo y edad.
...
\subsection{Egresados por rangos de edad y sexo}

En la tablas \ref{tab:n_per_sexo_edad} y \ref{tab:iess_edades_dist_rtr}, se presenta la cantidad de egresados por rangos de edades y sexo.
...
\subsection{Número de imposiciones }
En la tabla \ref{tab:n_imp_sexo_edad}, se presentan los resultados del número de imposiciones por rangos de edad y sexo de los egresados de la EPN. 
...
\subsection{Egresados por sector}

En las tablas \ref{tab:n_sec_p_sexo_edad} y \ref{tab:n_sec_pr_sexo_edad}, se representan la cantidad de estudiantes por rangos de edad y sexo de egresados de la EPN, de acuerdo al sector en el que desempeñan sus actividades, ya sea el sector público o privado respectivamente.
...
\multirow{2}[0]{*}{{\bf Rangos:}} & \multicolumn{2}{ c }{{\bf Masculino}} & \multicolumn{2}{ c }{{\bf Femenino}} &\multicolumn{2}{ c }{{\bf Total}}\\
\cmidrule(r){2-3} \cmidrule(r){4-5}\cmidrule(r){6-7}
& {\bf Sueldo (USD)} & {\bf Porcentaje (\%)} & {\bf Sueldo (USD)} & {\bf Porcentaje (\%)} & {\bf Sueldo (USD)} & {\bf Porcentaje (\%)} \\
\midrule
...
En la tabla \ref{tab:sld_banca_seg_3_2022} y figura \ref{fig:iess_sld_banca_seg}, se presenta el valor del sueldo promedio de los egresados en banca , seguros y otros a marzo del 2022 

\begin{figure}[H]
\centering
\captionsetup{justification=centering}
\caption{Sueldo Promedio en Banca y seguros }
...
En la figura \ref{fig:iess_sld_banca_seg_anio} y figura \ref{tab:sld_banca_seg_anio}, se presenta el valor del sueldo promedio de los egresados en banca , seguros y otros por años a partir del 2010 al 2022.
