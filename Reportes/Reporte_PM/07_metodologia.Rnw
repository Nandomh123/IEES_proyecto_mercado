...
asimismo, promedio del sueldo mensual tanto de hombres como de mujeres son idéntico, existe una pequeña diferencia a favor de los egresados de \$1,43, lo cual no es muy significativo debido a los altos sueldos promedios. 
