...
# Totales
sld_sec_p_sexo_edad <- rbind( sld_sec_p_sexo_edad , data.table(R_edad = 'Total', 
                                                             SM = c(colSums(sld_sec_p_sexo_edad[, 2:2]) ),
                                                             Dist_SM = colSums(sld_sec_p_sexo_edad[, 3:3] ),
                                                             SF = colSums(sld_sec_p_sexo_edad[, 4:4] ),
                                                             Dist_SF = colSums(sld_sec_p_sexo_edad[, 5:5] ),
                                                             ST = colSums(sld_sec_p_sexo_edad[, 6:6] ),
                                                             Dist_ST = colSums(sld_sec_p_sexo_edad[, 7:7])))
