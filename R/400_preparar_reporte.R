...
REP_file_latex_org <- c( paste( parametros$work_dir, 'Reportes/firma_actuario.png', sep = '' ),
...
REP_file_latex_des <- c( paste( parametros$resultado_seguro, 'graficos/firma_actuario.png', sep = '' ),
