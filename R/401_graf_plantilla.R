...
# Tema propio SPQ
theme_spq <- theme( legend.position = "bottom",
                    axis.text.x = element_text( angle = 0, hjust = 1 ),
                    legend.title = element_blank(),
                    panel.border = element_blank(),
                    legend.background = element_blank(),
                    legend.box.background = element_rect(colour = "black"),
                    panel.grid.major.y = element_line( colour = "white", size = graf_grid_major_size, linetype = 2 ),
                    panel.grid.major.x = element_line( colour = "white", size = graf_grid_major_size, linetype = 1 ),
